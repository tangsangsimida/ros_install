...
ros_dist_dic = {
    'artful': {"packages.ros", "https.packages.ros"},
    ...
    'disco': {"packages.ros", "https.packages.ros"},
    'eoan': {"packages.ros", "https.packages.ros"},
    ...
    'lucid': {"packages.ros", "https.packages.ros"},
    'maverick': {"packages.ros", "https.packages.ros"},
    'natty': {"packages.ros", "https.packages.ros"},
    'oneiric': {"packages.ros", "https.packages.ros"},
    'precise': {"packages.ros", "https.packages.ros"},
    'quantal': {"packages.ros", "https.packages.ros"},
    'raring': {"packages.ros", "https.packages.ros"},
    'saucy': {"packages.ros", "https.packages.ros"},
    'stretch': {"tsinghua", "ustc", "huawei", "packages.ros", "https.packages.ros"},
    'trusty': {"tsinghua", "ustc", "huawei", "packages.ros", "https.packages.ros"},
    'utopic': {"packages.ros", "https.packages.ros"},
    'vivid': {"packages.ros", "https.packages.ros"},
    'wheezy': {"packages.ros", "https.packages.ros"},
    'wily': {"packages.ros", "https.packages.ros"},
    'xenial': {"tsinghua", "ustc", "huawei", "mirrorz", "packages.ros", "https.packages.ros"},
    'yakkety': {"packages.ros", "https.packages.ros"},
    'zesty': {"packages.ros", "https.packages.ros"},
}
...
ros2_dist_dic = {
    ...
    'trusty': {"tsinghua", "ustc", "huawei", "packages.ros", "https.packages.ros"},
    'utopic': {"packages.ros", "https.packages.ros"},
    'xenial': {"packages.ros", "https.packages.ros"},
    'yakkety': {"packages.ros", "https.packages.ros"},
    'zesty': {"packages.ros", "https.packages.ros"},
}
